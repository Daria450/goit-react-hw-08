...
export const editContact = createAsyncThunk('editContact', async (body, thunkAPI) => {
    try {
        const response = await axios.patch(`/contacts/${body.id}`, { name: body.name, number: body.number });
